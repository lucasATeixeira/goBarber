...
const ProviderDashboardController = require('./app/controllers/ProviderDashboardController')
...
routes.get('/app/provider_dashboard', ProviderDashboardController.index)

routes.get('/app/appointments/new/:provider', AppointmentController.create)
routes.post('/app/appointments/new/:provider', AppointmentController.store)

routes.get(
  '/app/appointments/show/:cliente',
